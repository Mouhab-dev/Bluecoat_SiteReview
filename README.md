...
## Changes:
- I have decided to fork this project, to adjust the script and make it read a bulk of Domains/URLs from an input file, and output the not malicious (not yet identified by Bluecoat Sitereview) which you will need to block in your environment.
